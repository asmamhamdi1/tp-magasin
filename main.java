public class Main {
    public static void main(String[] args) {
        ...
        Magasin carrefour=new Magasin(120,"Centre-ville","Carrefour");
        Magasin monoprix=new Magasin(110,"Menzah6","Monoprix");

        Caissier caissier1=new Caissier(10,5,"asma","kasserin",2);
        Caissier caissier2=new Caissier(09,6,"maryem","Sidi bouzid",3);
        ...
        Caissier caissier3=new Caissier(10,5,"mourad","mnihla",2);
        Caissier caissier4=new Caissier(12,6,"rim","mestir",3);
        Caissier caissier5=new Caissier(13,6,"chahed","Menzah8",3);
        Vendeur vendeur=new Vendeur(15,8,"jawher","Sidi bouzid",50);
        Responsable responsable1=new Responsable(16,3,"hadil","Menzah6",15);
